function [TheBestNeuralNetworks]=Reg4Jobs_RepresentB_V4_ThroughputRADON_V2FunctionPicardsSixColu(InputPath)
...
AllMonodata1=load(fullfile(InputPath, 'p08+0+0-noht1/mondata.mat'));
%AllMonodata1=load('p08+0+0-noht1Good');
...
AllMonodata2=load(fullfile(InputPath, 'p08+0+0-noht2/mondata.mat'));
%AllMonodata2=load('p08+0+0-noht2Good');
...
AllMonodata3=load(fullfile(InputPath, 'p08+0+0-noht3/mondata.mat'));
%AllMonodata3=load('p08+0+0-noht3Good');
...
AllMonodata4=load(fullfile(InputPath, 'p08+0+0-noht4/mondata.mat'));
%AllMonodata4=load('p08+0+0-noht4Good');
