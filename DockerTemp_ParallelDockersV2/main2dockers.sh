...
mkdir -p /container_data/$3
echo "111111111111"
~/DockerTemp_ParallelDockersV2/main_rundocker1.sh $testname $1 $3 &
echo " 2222222222222222222"
~/DockerTemp_ParallelDockersV2/main_rundocker2.sh $testname $2 $3 &
echo "33333333333333333"
...
mv log.sar /container_data/$3/$testname/log.sar
