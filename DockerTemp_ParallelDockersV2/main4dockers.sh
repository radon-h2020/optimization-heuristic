...
mkdir -p /container_data/$5
echo "111111111111"
~/DockerTemp_ParallelDockersV2/main_rundocker1.sh $testname $1 $5 &
echo " 2222222222222222222"
~/DockerTemp_ParallelDockersV2/main_rundocker2.sh $testname $2 $5 &
echo "33333333333333333"
~/DockerTemp_ParallelDockersV2/main_rundocker3.sh $testname $3 $5 &
echo "4444444444444444"
~/DockerTemp_ParallelDockersV2/main_rundocker4.sh $testname $4 $5 &
...
mv log.sar /container_data/$5/$testname/log.sar
